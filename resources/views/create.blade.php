...
<body>
    ...
    <div class="container mt">
        <form action="/store" method="post">
            @csrf
            <div class="mb-3">
                <label for="tipe_cake" class="form-label">Kode</label>
            ...
            <div class="mb-3">
            <label for="banyak_layer" class="form-label">Nama</label>
            ...
            <div class="mb-3">
                <label for="jumlah_lilin" class="form-label">Papan Pencatatan</label>
            ...
            <div class="mb-3">
                <label for="pesan_pada_cake" class="form-label">Papan Pencatatan</label>
            ...
            <div class="mb-3">
                <label for="menu_id" class="form-label">Volume</label>
